...
class GraphFrame:
    ...
    @staticmethod
    def from_caliper_json_with_module(filename_or_stream, module_filename):
        """Read in a Caliper `cali-query` JSON-split file or an open file object
        along with the module mapping information.
        ...
        """
        # import this lazily to avoid circular dependencies
        from .readers.caliper_reader_module import CaliperReaderWithModule

        return CaliperReaderWithModule(filename_or_stream, '', module_filename).read()
